...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ServerContact'
        db.create_table('main_servercontact', (
        ...
        db.send_create_signal('main', ['ServerContact'])


    def backwards(self, orm):
        # Deleting model 'ServerContact'
        db.delete_table('main_servercontact')
    ...
    models = {
        ...
        'main.servercontact': {
            'Meta': {'ordering': "('_order',)", 'object_name': 'ServerContact'},
            '_order': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'contact': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['main.Contact']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'server': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['main.Server']"})
