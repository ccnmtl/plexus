...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('main_server', 'location_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Location'], null=True))

    def backwards(self, orm):

        # Changing field 'Server.location'
        db.alter_column('main_server', 'location_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['main.Location']))
