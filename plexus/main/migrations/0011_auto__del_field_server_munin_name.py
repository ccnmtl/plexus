...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Server.munin_name'
        db.delete_column(u'main_server', 'munin_name')


    def backwards(self, orm):
        # Adding field 'Server.munin_name'
        db.add_column(u'main_server', 'munin_name',
    ...
    models = {
        ...
        u'main.server': {
            ...
            'virtual': ('django.db.models.fields.BooleanField', [], {})
        },
