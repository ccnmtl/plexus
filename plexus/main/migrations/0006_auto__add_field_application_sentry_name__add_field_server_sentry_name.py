...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Application.sentry_name'
        db.add_column('main_application', 'sentry_name',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=256, blank=True),
                      keep_default=False)

        # Adding field 'Server.sentry_name'
        db.add_column('main_server', 'sentry_name',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=256, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Application.sentry_name'
        db.delete_column('main_application', 'sentry_name')

        # Deleting field 'Server.sentry_name'
        db.delete_column('main_server', 'sentry_name')
